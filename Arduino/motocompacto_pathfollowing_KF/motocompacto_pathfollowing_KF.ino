...
unsigned long GPSAge = -1;
float x, y, z;
float oldx,oldy,oldz;
float yawBias=0;
float KPrev = .025; // originally .05, .025 worked
float KdPrev = .025; // originally .05, .025 worked
float previewDist = 5.0; // originally 4, 5 worked
float ePrev = 0;
float station = 0;
float ePrev_old = 0;
float dEPrev = 0;
